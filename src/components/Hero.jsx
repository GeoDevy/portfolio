            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    <div className="relative">
                        <div className="relative rounded-full p-[3px] shadow-2xl shadow-[var(--color-primary)]/20">
                            <img
                ...
                >
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold leading-tight tracking-tight">
                        <span className="text-[var(--color-text-light)]">Dev</span>
                        {' '}
                        <span className="text-[var(--color-text-light)]">Kumar</span>
                    </h1>
                </motion.div>
                    ...
                    <div className="h-8 relative overflow-hidden">
                        <AnimatePresence mode="wait">
                            <motion.p
                                ...
                                className="text-xl md:text-2xl text-[var(--color-accent-light)] font-light tracking-wide"
                            >
                                {roles[roleIndex]}
                            </motion.p>
                        </AnimatePresence>
