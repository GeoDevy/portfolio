...
const projects = [
    ...
    {
        title: 'LULC Analysis — Gurugram',
        description: 'Land use and land cover classification of Gurugram district using satellite imagery to track urban expansion and environmental changes.',
        image: '/images/gurugram-lulc.jpg',
        fit: 'contain',
        tags: ['LULC', 'ArcGIS Pro', 'Classification'],
    },
    {
        ...
        fit: 'contain',
        tags: ['NDVI', 'Vegetation', 'ERDAS Imagine'],
    },
    {
        ...
        fit: 'cover',
        tags: ['Cartography', 'DEM', 'Topography'],
    },
    {
