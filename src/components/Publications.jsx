                ...
                <div className="space-y-5">
                    {publications.map((pub, i) => (
                        <motion.article
                            ...
                            className="flex gap-5 p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-card)] hover:shadow-xl hover:-translate-y-1 hover:border-[var(--color-primary)]/30 transition-all duration-300 relative overflow-hidden group"
                        >
